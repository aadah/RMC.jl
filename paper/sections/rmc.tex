...
the near-exact $t'$ representing the imminent point of collision while still
satisfying $\CSof{\qof{t'}} > 0$. \cref{alg:temporalsearch} outlines the
procedure in fuller detail.
